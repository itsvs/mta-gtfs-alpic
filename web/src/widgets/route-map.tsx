  ...
  return (
    <div style={{ width: "100%", height: "100%", minHeight: "500px", backgroundColor: "#f9f9f9" }}>
      {routeShape && (
        ...
        >
          <div>
            <div style={{ fontSize: "18px", fontWeight: "600", marginBottom: "4px" }}>{routeShape.routeName}</div>
      ...
      <div style={{ width: "100%", height: routeShape ? "calc(100% - 80px)" : "100%", minHeight: "400px" }}>
        ...
        >
          ...
          {routeShape?.startMarker && (
            <Marker position={[routeShape.startMarker.lat, routeShape.startMarker.lng]} icon={startIcon}>
              <Popup>
                <strong>{routeShape.startMarker.name}</strong>
                <br />
                <span style={{ color: "#22c55e" }}>● Start Station</span>
                <br />
          ...
          {routeShape?.endMarker && (
            <Marker position={[routeShape.endMarker.lat, routeShape.endMarker.lng]} icon={endIcon}>
              <Popup>
                <strong>{routeShape.endMarker.name}</strong>
                <br />
                <span style={{ color: "#ef4444" }}>■ End Station</span>
                <br />
